...
$categoriaController = new AutorController();
$router->add('GET', '/autores', fn() => $categoriaController->index());
$router->add('GET', '/autores/:id', fn($id) => $categoriaController->show($id));
$router->add('POST', '/autores', fn() => $categoriaController->store());
$router->add('PUT', '/autores', fn() => $categoriaController->update());
$router->add('DELETE', '/autores', fn() => $categoriaController->destroy());
